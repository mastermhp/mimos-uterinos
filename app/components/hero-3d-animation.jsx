      ...
      {/* {showInfo && (
        <Html position={[0, isMobile ? -3 : 0, 2]} center>
          <motion.div
            ...
            className="bg-white/90 dark:bg-slate-900/90 p-4 sm:p-6 rounded-xl shadow-xl backdrop-blur-sm max-w-[280px] sm:max-w-md"
          >
            ...
            <p className="mb-4 text-sm sm:text-base text-slate-700 dark:text-slate-300">
              Track and visualize your menstrual cycle with our AI-powered app. Get personalized insights and
              predictions.
            </p>
            <div className="flex gap-2 sm:gap-3">
              ...
              <Link href="/demo/user">
                <Button variant="outline" className="text-xs sm:text-sm">Try Demo</Button>
              </Link>
            </div>
          </motion.div>
        </Html>
